...
```yaml
  - job_name: "node_exporter"         # Job name for node exporter
    ...
    static_configs:
      - targets: ["192.168.1.17:9100"]  # Target node exporter endpoint
```
  ...
  - job_name: 'blackbox'              # Job name for blackbox exporter
    ...
    static_configs:
      - targets:
        ...
        - http://192.168.1.17:8080/  # HTTP target with port 8080
    relabel_configs:
      ...
      - target_label: __address__
        replacement: 192.168.1.17:9115  # Blackbox exporter address
```
